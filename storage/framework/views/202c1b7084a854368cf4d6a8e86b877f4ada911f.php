...
<html lang="pt-br">
    <head>
        ...
        <title>VetClin - <?php echo $__env->yieldContent('titulo'); ?></title>
    ...
    <body>
        <nav class="navbar sticky-top navbar-expand-md navbar-dark bg-secondary">
            <div class="container-fluid">
                <a href="<?php echo e(route('index')); ?>" class="navbar-brand ms-sm-3">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown ps-2">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo e(route('clientes.index')); ?>" class="dropdown-item">Clientes</a></li>
                                <li><a href="<?php echo e(route('veterinarios.index')); ?>" class="dropdown-item">Veterinários</a></li>
                                <li><a href="<?php echo e(route('especialidades.index')); ?>" class="dropdown-item">Especialidades</a></li>
                            </ul>
                        </li>
...
</html><?php /**PATH /home/aluno/Área de Trabalho/start-project/resources/views/templates/main.blade.php ENDPATH**/ ?>